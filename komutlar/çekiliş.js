            ...
            msg.edit(':eight_pointed_black_star:| **Şimdi de ödülü yaz bakalım**').then(msg => {
              message.channel.awaitMessages(filter, {
                ...
                try {
                  ...
                  .setFooter(message.author.username + " (FairyTale Bot Çekiliş Sistemi )", message.author.avatarURL);
			...
			.setFooter("(DTBS bot çekiliş sistemi)")
                     ...
                     m.edit('** 🎉 ÇEKİLİŞ BİTTİ 🎉**' , {embed: endEmbed});
                       ...
                       var embedLel = new Discord.RichEmbed()
                        .setColor("#f558c9")
                        .setDescription("Ödülünü destek talebi açarak elde edebilirsin!").setFooter("(FairyTale bot çekiliş sistemi)")
