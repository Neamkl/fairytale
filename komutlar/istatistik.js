...
module.exports.run = async(client, message, args) => {
  const duration = moment.duration(client.uptime).format(" D [gün], H [saat], m [dakika], s [saniye]");
    ...
    .addField(`Discord.js sürümü:`, Discord.version)
      .addField(':spy: Yapımcım:', '<@464845806604910592> \n `?SaFIRTINA?#8875`')
      .addField(':paperclip: Botun Başlanma Zamanı:', "Bot **28.02.2019** Tarihinde yapılmaya başlanmıştır")
    .setFooter('FairyTale', client.user.avatarURL)
    .setTimestamp()
